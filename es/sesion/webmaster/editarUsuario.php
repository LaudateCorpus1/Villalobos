						...
						<form action="php/editarUsuario.php" method="POST">
							...
							<input type="hidden" name="id_usuario" value="<?PHP echo $id_usuario; ?>">
								<div class="form-group">
			    					...
			    					<input name="nombre" type="text" class="form-control" id="exampleInputName2" value="<?PHP echo $nombre; ?>">
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Apellido Paterno:</strong></label>
			    					<input name="apellido_p" type="text" class="form-control" id="exampleInputName2" value="<?PHP echo $apellido_p; ?>">
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Apellido Materno:</strong></label>
			    					<input name="apellido_m" type="text" class="form-control" id="exampleInputName2" value="<?PHP echo $apellido_m; ?>">
		  						</div>
		  						<div class="form-group">
		  						...
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Fecha:</strong></label>
			    					<input name="fecha" type="text" class="form-control" id="exampleInputName2" value="<?PHP echo $fecha; ?>">
		  						</div>
							</div>
