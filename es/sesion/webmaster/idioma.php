...
<html lang="es" ng-app="myNoteApp">
	...
	<body>
		...
		<h1 class="text-primary">Escribir en otro idioma <small>Recuerda llenar todos los campos</small></h1>
		<br><br>
				<form action="php/idioma.php" method="POST" enctype="multipart/form-data">
				  	...
				  	<div class="form-group">
			    		...
			    		<textarea class="form-control" name="encabezado" placeholder="Encabezado" required></textarea>
				  	</div>
				  	<div class="form-group ">
		    		...
		    		<div class="form-group" id="imagen">
				  	...
				  	<div class="form-group">
			    		...
			    		<textarea class="form-control" name="noticia" rows="10"  placeholder="Escribe la noticia aquí..." required></textarea>
				  	</div>
				  	<div class="form-group">
				    	<label>Autor</label>
				  	...
				  	<div class="form-group">
				  		...
				  		<select name="idioma" class="form-control" title="Idioma" required readonly >
							<?php
