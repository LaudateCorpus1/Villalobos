		...
		<div class=" ">
			...
			<div class="container">
				<div class="row">
					...
					<br><br>
						<form action="php/agrUsuario.php" method="POST">
							<div class="col-md-4 col-md-offset-2">
								<div class="form-group">
			    					<label for="exampleInputName2"><strong>Nombre:</strong></label>
			    					<input name="nombre" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Apellido Paterno:</strong></label>
			    					<input name="apellido_p" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Apellido Materno:</strong></label>
			    					<input name="apellido_m" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Calle:</strong></label>
			    					<input name="calle" type="text" class="form-control" id="exampleInputName2">
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Número:</strong></label>
			    					<input name="numero" type="text" class="form-control" id="exampleInputName2">
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Colonia:</strong></label>
			    					<input name="colonia" type="text" class="form-control" id="exampleInputName2">
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>C.P.:</strong></label>
			    					<input name="cp" type="text" class="form-control" id="exampleInputName2">
		  						</div>
							</div>
							<div class="col-md-4 col-md-offset-1">							  
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Teléfono:</strong></label>
			    					<input name="telefono" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Celular:</strong></label>
			    					<input name="celular" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Correo:</strong></label>
			    					<input name="correo" type="email" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Usuario:</strong></label>
			    					<input name="usuario" type="text" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Contraseña:</strong></label>
			    					<input name="contra" type="password" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
			    					<label for="exampleInputName2"><strong>Repetir Contraseña:</strong></label>
			    					<input name="r_contra" type="password" class="form-control" id="exampleInputName2" required>
		  						</div>
		  						<div class="form-group">
							  		<label><strong>Seleccione el Perfil</strong></label>
							  		<select name="perfil" class="form-control" title="Perfil" required >
						                <option value="">Perfil</option>
						                <option value="webmaster">master</option>
